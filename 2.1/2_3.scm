...
(define (length square )
    (let (( start ( start-point square ) )
         ( end   ( end-point square ) ))
         ( max ( abs (- (x-point start ) ( x-point end ) ) )
...
(define (width square )
    (let (( start ( start-point square ) )
         ( end   ( end-point square ) ))
         ( min ( abs ( - (x-point start ) ( x-point end ) ) )
               ( abs ( - (y-point start ) ( y-point end ) ) )
         )
    )
)

(define (perimeter square )
    ( * 2 ( + ( length square ) ( width square ) ))
)

(define (area square )
    ( * ( length square ) ( width square ) )
)
